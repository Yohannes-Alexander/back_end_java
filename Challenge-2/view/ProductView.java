...
public class ProductView {
    ...
    public int listProduct(List<Product> menuProduct){
        ...
        for (Product p : menuProduct) {
            System.out.println(p.getId() + ". " + p.getNama() + "\t| " + p.getHarga());
        }
    ...
    public int confirmedMenu(List<OrderDetail> menuProduct, int totalQuantity, int totalPrice){
        ...
        for (OrderDetail p : menuProduct){
            System.out.println( p.getProduct().getNama()+"\t" + p.getAmount() +"\t" +p.getAmount()*p.getProduct().getHarga());
        }
        System.out.println("---------------------------------+");
